...
from app.schema.photo import PresignedUrlRequest, ConfirmUploadRequest
...
class StorageService:
    ...
    def generate_presigned_url_put(self, request: PresignedUrlRequest) -> dict:
        ...
        The client should then perform a PUT to this URL with the returned headers,
        including the x-amz-meta-* headers so that metadata is recorded correctly.
        """
        try:
